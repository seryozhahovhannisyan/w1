...
<head>
    ...
    <script type="text/javascript">
        ...
        function footerPlace() {
            var header_height = $(".header_div").outerHeight();
            console.log("header_height", footer_height);
...
<div class="container-fluid main_cont">
    <div class="container  ">
        <div class="row">
            ...
            <div class="row">
                <div class="number_div  centered col-lg-4 col-md-6 col-sm-5 col-xs-8">
                    <s:property value="#session.err_code"/>
                    <s:set var="#session.err_code" value=""/>
                    <s:set var="err_code" value="" scope="session"/>
                </div>
            </div>
            <div class="row">
                <div class="info_div  centered col-lg-4 col-md-6 col-sm-5 col-xs-8">
                    ...
                    <s:set var="err_message" value="" scope="session"/>
                </div>
            </div>
            <div class="row">
                <div class="button_div  centered col-lg-4 col-md-6 col-sm-5 col-xs-8">
                    <button onclick="goToAction('/index.jsp')">
                        go back
                    </button>
                </div>
            </div>
