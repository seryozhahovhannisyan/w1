...
<link rel="stylesheet"
      href="<%=request.getContextPath()%>/css/wallet/wallet_mobile/wallet_pending_transaction_mobile.css">
<link href="<%=request.getContextPath()%>/css/general/datepicker_bootstrap.css" rel="stylesheet">
<link rel="stylesheet" href="<%=request.getContextPath()%>/css/wallet/wallet_mobile/mobile_block_user.css">
...
<script type="text/javascript">
    ...
    var var_default_position_scrolling_popup_pending_transaction = undefined;
    var array_ids = [];
    ...
    function default_position_scrolling_popup_pending_transaction() {
...
//            $(".amount_less input").val("");
    ...
    function sort_arrow_img() {
        $(".up").click(function () {
            $('.arrow_div img').attr('src', '<%=request.getContextPath()%><%=request.getContextPath()%>/img/wallet/icon/arrow_up_icon.png');
            $('.arrow_div span:nth-child(1)').html("desc");
            call_pending_transaction()
        });
        $(".down").click(function () {
            $('.arrow_div img').attr('src', '<%=request.getContextPath()%><%=request.getContextPath()%>/img/wallet/icon/arrow_down_icon.png');
            ...
            $.each(pendingTransactions, function (i, item) {
                ...
                if (pending != null) {
                    ...
                    if (pending.debited) {
                        ...
                        src_completed_minus = "img/wallet/icon/wallet_minus_icon.png";
...
//                    img_minus_icon.appendTo(div);
                    ...
                    $('.for_next_previews_buttons' + transaction_id).click(function () {
                        var_default_position_scrolling_popup_pending_transaction = true;
