                ...
                if (data != null && data.responseDto.status == "SUCCESS") {
                    ...
                    $.each(credit_cards, function (i, item) {
                        ...
                        var enable_disable = item.isEnabled
                                ...
                                : '<div data-type="1" data-id="' + id + '" class="cart_disabel" style="background-image: url(/img/wallet/icon/wallet_credit_enable.png); color: rgb(0, 200, 101);"><s:text name="wallet.credit.card.enable">Enable</s:text></div>';
                        ...
                        if (holderName != "" && card_number != "" && month != "" && year != "") {
                            ...
                            switch (trans_type){
                                case "DISCOVER":
                                    $('.type_cards' + id + '').css("background-image", "url('/img/wallet/cardsLogo/discover.png')");
                                    break;
                                case "MASTER_CARD":
                                    $('.type_cards' + id + '').css("background-image", "url('/img/wallet/cardsLogo/mastercard.png')");
                                    break;
                                case "VISA_CARD":
                                    $('.type_cards' + id + '').css("background-image", "url('/img/wallet/cardsLogo/vsisa.png')");
                                    break;
                                case "AMERICAN_EXPRESS":
                                    $('.type_cards' + id + '').css("background-image", "url('/img/wallet/cardsLogo/american_express.png')");
                                    break;
                                case "DINERS_CLUB":
                                    $('.type_cards' + id + '').css("background-image", "url('/img/wallet/cardsLogo/diners_club.png')");
                                    break;
                                case "JCB":
                                    $('.type_cards' + id + '').css("background-image", "url('/img/wallet/cardsLogo/jcb.png')");
                                    break;
                            }
                        }
                    });
    ...
    function disable_enable_card() {
        $("body").delegate(".cart_disabel", "click", function () {
            ...
            if ($(this).data("type") == 1) {
                ...
                type_ = 1;
                color = '#00c865';
                img = "/img/wallet/icon/wallet_credit_enable.png";
