...
<s:if test="#session.confirmed != null && #session.confirmed">
    ...
    <link rel="stylesheet" href="<%=request.getContextPath()%>/css/wallet/wallet_mobile/wallet_person_panel_mobile.css">
...
//            run_test();
    ...
    <aside class="aside">
        ...
        <div class="left_menu_icon bordered">
            <div class="left_menu_img">
                <img onclick="goToAction('completed-transaction.htm')" style="width: 75%"
            ...
            <div style="clear: both; display: inline-block"></div>
                <span onclick="goToAction('completed-transaction.htm')" class="completed">
        ...
        <div class="left_menu_icon">
            <div class="left_menu_img">
                <img onclick="goToAction('credit-cards-view.htm')" style="width: 75%"
                     src="<%=request.getContextPath()%>/img/wallet/icon/credit_card_icon.png" alt="avatar"/>
            </div>

                    <span onclick="goToAction('credit-cards-view.htm')" class="credit_card_mobile">
        ...
        <%}%>
            <div class="left_menu_icon bordered">
                ...
                <div style="clear: both; display: inline-block"></div>
                <span onclick="goToAction('settings.htm')" class="settings_mobile">
            ...
            <div class="header_logo">
                ...
                <div class="back_menu_person_panel">
                    <img src="<%=request.getContextPath()%>/img/wallet/icon/wallet_settings_back.png" alt="menu"/>
                </div>
...
<s:else>
    <link rel="stylesheet" href="<%=request.getContextPath()%>/css/wallet/wallet_mobile/wallet_home_mobile.css"
          media="screen">
