...
<link rel="stylesheet" href="<%=request.getContextPath()%>/css/wallet/wallet_settings.css">
<link rel="stylesheet" href="<%=request.getContextPath()%>/css/wallet/block_user.css">
<script type="text/javascript" src="<%=request.getContextPath()%>/js/wallet/wallet_settings.js"></script>
            ...
            <div class="fees_clases">
                <table class="fee_table">
                    ...
                    <th class="table_th">
                        ...
                        <s:text name="wallet.general.wallet.fees.sender">Sender</s:text>

                    </th>
                    <th class="table_th">
                        <img src="<%=request.getContextPath()%>/img/wallet/icon/requst_transaction.png" alt="send">
                        <s:text name="wallet.general.wallet.fees.receiver">Receiver</s:text>
                    </th>
                    <th class="range_fee">
