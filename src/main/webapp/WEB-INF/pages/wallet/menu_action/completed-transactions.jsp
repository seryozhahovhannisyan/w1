...
<link rel="stylesheet" href="<%=request.getContextPath()%>/css/wallet/transaction.css">
...
//            }
        ...
        $('.arrow-left-payment-popup-dispute').click(function() {
            params_next_prev_dispute.transaction_id = dispute_logic_show_completed_transaction_popup_previous();
        });

        $('.arrow-right-payment-popup-dispute').click(function() {
    ...
    function dispute_logic_show_completed_transaction_popup_previous( ){
        $('.arrow-right-payment-popup-dispute').show();
        for (var i = 0; i < params_next_prev_dispute.array_transaction_id_dispute.length; i++) {
            if (params_next_prev_dispute.array_transaction_id_dispute[i] == params_next_prev_dispute.transaction_id && params_next_prev_dispute.array_transaction_id_dispute.length >= 2) {
                ...
                if (params_next_prev_dispute.array_transaction_id_dispute[i-2] == undefined && previews_transaction_id != undefined) {
                    $('.arrow-left-payment-popup-dispute').hide();
                    ...
                    $('.arrow-left-payment-popup-dispute').show();
                    dispute_show_pending_transaction_popup(previews_name, previews_id, previews_partitionId, previews_img_src, previews_transaction_id, previews_wallet_exchange_id, previews_dispute_text, previews_disputeId);
    ...
    function dispute_logic_show_completed_transaction_popup_next( ){
        ...
        for (var i = params_next_prev_dispute.array_transaction_id_dispute.length; i >= 0; i--) {
            if (params_next_prev_dispute.array_transaction_id_dispute[i] == params_next_prev_dispute.transaction_id && params_next_prev_dispute.array_transaction_id_dispute.length >= 2) {
                ...
                if (params_next_prev_dispute.array_transaction_id_dispute[i+2] == undefined && previews_transaction_id != undefined) {
                    $('.arrow-right-payment-popup-dispute').hide();
                    dispute_show_pending_transaction_popup(previews_name, previews_id, previews_partitionId, previews_img_src, previews_transaction_id, previews_wallet_exchange_id, previews_dispute_text, previews_disputeId);
                } else if (previews_transaction_id == undefined) {
                    $('.arrow-right-payment-popup-dispute').hide();
                } else {
    ...
    function datepickerCancelSubmit() {
        var con = '<div class="datepicker_header">' +
                ...
                '</div>';
        if($(".datepicker .datepicker_header").length == 0){
...
//                        $(".one_start_date_date").data("search_date_great",arr_input_value[0]);
    ...
    function unite_criteria() {
        ...
        params.current_page_exchange = $(".search_result").attr("data-current_page_exchange");
    ...
    function search_row_design() {
        ...
        var margin_center_height4 = ($(".date_parent_div").height() - $(".div_margin_height4").outerHeight()) / 2;
        ...
        $(".exchange").css("height", date_search_height);
        $(".search_dispute_checkbox").css("height", date_search_height);
        ...
        $(".div_margin_height4").css("margin-top", margin_center_height4 + "px");
    ...
    var completed_load_available_currencies_callback = function (data,current_page){
        console.log("completed transaction data", data, "fff", current_page);
        var cont;
...
//                                          '<div class="disput_div" onclick=goToAction("' + func_dispute + '")>' +
                            '<div class="disput_div " data-dispute_id = "' + disputeId + '"  data-dispute_txt = "' + txt_dispute + '" data-transaction_id="' + transaction_id + '" data-id="' + id + '" data-partition_id="' + partitionId + '" data-img_src="' + src + '" data-name="' + ns + '">' +
                            '<img  class="tr_id' + transaction_id + '"  src="' + src_dispute + '" alt=""/>' +
                            '</div>' +
                            '<div class="disput_text_div tr_tx_id' + transaction_id + '  text-center" data-dispute_txt = "' + txt_dispute + '" data-dispute_id = "' + disputeId + '" data-transaction_id="' + transaction_id + '" data-id="' + id + '" data-partition_id="' + partitionId + '" data-img_src="' + src + '" data-name="' + ns + '">' +
...
//                                          '<div class="disput_text_div text-center" data-name="'+ns+'">' +
                    ...
                    $('.for_next_previews_buttons_img' + transaction_id).click(function () {
                        ...
                        if (array_transaction_id_dispute[0] == transaction_id) {
                            $('.arrow-left-payment-popup-dispute').hide();
                        }
                        else {
                            $('.arrow-left-payment-popup-dispute').show();
                        }
                        if (array_transaction_id_dispute[array_transaction_id_dispute.length - 1] == transaction_id) {
            ...
            <div class="row" style="border-bottom: 1px solid #555965">
                ...
                <div class="search_dispute_checkbox">
                    <div class="div_margin_height3">
                        ...
                        <div class="choose_dispute_type"><s:text
                                name="wallet.transaction.show.both">Show All</s:text></div>
                    </div>
                        ...
                        <div class="show_only_pending">
                            <div data-id="<%=DisputeState.PENDING.getId()%>">
                                <img src="<%=request.getContextPath()%>/img/wallet/icon/wallet-disput_icon_pending.png"
                                     alt="disput logo">
                                <s:text name="wallet.login.completed.transaction.disputing">Disputing</s:text></div>
                        </div>
                        ...
                        <div class="show_only_closed">
                            <div data-id="<%=DisputeState.ClOSE.getId()%>">
                                <img src="<%=request.getContextPath()%>/img/wallet/icon/wallet-disput_icon_closed.png"
                                     alt="disput logo">
                                <s:text name="wallet.login.completed.transaction.dispute.closed">Closed</s:text></div>
                        </div>
                ...
                <div class="exchange">
                    <div class="div_margin_height4">
                        <div class="exchange_text">
                            <s:text name="wallet.exchange.history">Exchange history</s:text>
                        </div>
                    </div>
                </div>
    ...
    <div class="container ">
        <div class="row">
            <div class="popup_main">
                <div class="arrow-left-payment-popup-dispute"><img src="<%=request.getContextPath()%>/img/wallet/icon/send_money_popup_arrow.png" alt="arrow icon"/></div>
                ...
                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                    <div class="popup_left">
                        ...
                        <form action="transaction_data_upload.htm" id="file_upload_form" method="post"
                            ...
                            <input id="d_wallet_exchange_id" type="hidden"/>
