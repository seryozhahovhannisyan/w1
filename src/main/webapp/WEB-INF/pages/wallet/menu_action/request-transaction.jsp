...
function select_blur(){
    $(".show_request_money_trans").click(function () {
        $(".popup_ammount_input").css("border","none");
         if ($(".popup_ammount_input").val().trim() != "") {
            ...
            data.currencyType = $("#currencyType option:selected").val();
            params.data = data;
            WALLET.request_transaction_check_tax(params, request_money_check_tax_callback, error_handler);
        }
         else{
    ...
    $.ajax({
        ...
        success: function (data) {
            if (data != null && data.responseDto.status == "SUCCESS") {
                ...
                if (search_users != null && search_users.length) {
            ...
            <div class="popup_main">
                ...
                <div class="popup_sm_header_parent">
                    <div class="popup_sm_header">
                        ...
                        <div>
                            <span class="show_request_money_trans">
                                <s:text name="wallet.login.request.transaction">Request transaction</s:text>
                            </span>
                            <span class="show_request_money_trans">
                                <img src="<%=request.getContextPath()%>/img/wallet/icon/requst_transaction.png"
                                     alt="envelop icon"/>
                            </span>
                        </div>
                    </div>
