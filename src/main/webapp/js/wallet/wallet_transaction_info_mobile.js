...
function transaction_info(params) {
    ...
    if (params.transaction_completed == true){
        if (var_default_position_scrolling_popup_completed_transaction === true) {
            default_position_scrolling_popup_completed_transaction();
        }
    } else {
        if (var_default_position_scrolling_popup_pending_transaction === true) {
            default_position_scrolling_popup_pending_transaction();
        }
    }
    ...
    function scrolling_popup() {
        ...
        $(".container-for-scroll-sliding").scroll(function(event) {
            ...
            if ((scrollleft > need_margin_left + 40) && disable_previews_scroll !== true){
                console.log('scrollleft plus', scrollleft);
                console.log('need_margin_left plus', need_margin_left);
                ...
                if (disable_previews_scroll !== true) {
            ...
            // }
            else if ((scrollleft < need_margin_left - 40) && disable_next_scroll !== true){
                console.log('scrollleft minus', scrollleft);
                console.log('need_margin_left plus', need_margin_left);
                //  $(".popup_cont_transfer").hide();
                if (params.transaction_completed == true){
                    params_next_prev.transaction_id = logic_show_completed_transaction_popup_next();
