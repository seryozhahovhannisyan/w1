...
$(document).ready(function () {
    ...
    blocked_user_mobile_view();


});

function blocked_user_mobile_view() {
    $(".blocked_user_tab").click(function () {
        $(".blocked_user_right_part").hide();
        $(".popup_cont").hide();
        $(".blocked_user_left_part").show();
        $("body").css("background-size", "auto");
        call_load_blocked_users();
    })

    $(".all_user_tab").click(function () {
        $(".blocked_user_right_part").show();
        $(".blocked_user_left_part").hide();
        call_load_users();

    })

    $(".back_menu_person_panel").click(function () {
        $(this).hide();
        $(".left_part").show();
        $(".right_part").hide();
        $(".menu_person_panel").show();
        $(".popup_cont").hide();
        footerPlace();
    })
}
...
function change_tabs(sel1, sel2) {
    ...
    $(sel1).click(function () {
        ...
        $(".left_part").hide();
        $(".menu_person_panel").hide();
        $(".back_menu_person_panel").show();
        $(".right_part").show();
        $(sel2).show();
