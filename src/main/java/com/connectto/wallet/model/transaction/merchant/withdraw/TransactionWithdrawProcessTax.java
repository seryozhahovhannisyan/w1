...
public class TransactionWithdrawProcessTax {
    ...
    public TransactionWithdrawProcessTax(Date actionDate, Long walletId, Long setupId, Double processTax, CurrencyType processTaxCurrencyType, TransactionTaxType processTaxType) {
    ...
    public TransactionWithdrawProcessTax(Date actionDate, Long walletId, Long setupId, Double processTax, CurrencyType processTaxCurrencyType, Double processTaxPrice, CurrencyType processTaxPriceCurrencyType, TransactionTaxType processTaxType, TransactionWithdrawExchange exchange) {
        this.actionDate = actionDate;
        this.walletId = walletId;
        this.setupId = setupId;
        this.processTax = processTax;
