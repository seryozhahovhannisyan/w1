...
public class UAgentInfo {
    ...
    //
    String os = "";
    public boolean isPC = false ; //Stores the result of detectIsPersonalComputer()
    ...
    public UAgentInfo(String userAgent, String httpAccept) {
        ...
        initDeviceScan();
        initOsAndBrowserScan(userAgent);
    }

    private void initOsAndBrowserScan(String userAgent) {
        //=================OS=======================
    ...
    public boolean getIsPersonalComputer(){
        return isPC;
    }
}